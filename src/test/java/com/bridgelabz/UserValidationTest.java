...
public class UserValidationTest {
    ...
    public void givenFirstName_whenValid_shouldReturnTrue() {
        ...
        boolean result;
        try {
            result = userValidation.validateFirstName("Anirban");
    ...
    public void givenLastName_whenValid_shouldReturnTrue() {
        boolean result;
        try {
            result = userValidation.validateLastName("Nayak");
            Assert.assertEquals(true, result);
        } catch (UserValidationException e) {
        }
    ...
    public void givenEmail_whenValid_shouldReturnTrue() {
        boolean result;
        try {
            result = userValidation.validateEmail("anirban.vj@gmail.com.vj");
            Assert.assertEquals(true, result);
        } catch (UserValidationException e) {
        }
    ...
    public void givenEmail_whenInvalid_shouldReturnFalse() {
        boolean result;
        try {
            result = userValidation.validateEmail("anirban.@gmail.com");
            Assert.assertEquals(false, result);
        } catch (UserValidationException e) {
        }
